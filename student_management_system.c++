...
class Student : public info{
    ...
    void updateStudent(){
        ...
        cout << "===============================" << endl << endl;
        cout << "Enter the roll number of the student to be edited: ";
        cin >> num;
...
int main(){
    ...
    cout << "\t\tMAIN MENU" << endl;
    cout << "\t\t--------------------------" << endl;
    cout << "\t\t 1. Add Info Of New Student" << endl;
    cout << "\t\t 2. Display Info Of All Students " << endl;
    cout << "\t\t 3. Search Info Of Student By Roll" << endl;
    cout << "\t\t 4. Update Info Of Student" << endl;
    cout << "\t\t 5. Delete Info Of A Student" << endl;
    cout << "\t\t 6. Delete Info OF All Students" << endl;
    cout << "\t\t 0. Exit" << endl;
